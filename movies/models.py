...
class Movie(models.Model):
    ...
    actors = models.ManyToManyField(Actor, verbose_name="актер", related_name="film_actors")
    genres = models.ManyToManyField(Genre, verbose_name="жанры")
    world_premier = models.DateField("Премьера в мире", default=date.today)
    budget = models.PositiveIntegerField("Бюджет", default=0, help_text="указать сумму в долларах США")
    fees_in_russia = models.PositiveIntegerField(
        "Сборы в РФ", default=0, help_text="указать сумму в долларах США"
    )
    fees_in_world = models.PositiveIntegerField(
        "Сборы в мире", default=0, help_text="указать сумму в долларах США"
    )
