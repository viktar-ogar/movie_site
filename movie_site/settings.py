...
#SECRET_KEY = ')z3v^c-udo15gj8kwflh+s=zszxpyjw$7^*0ys2!)a@m*fhhng'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'movie_site/static'),
    ]
...
# CKeditor - Исходный код: https://github.com/django-ckeditor/django-ckeditor
